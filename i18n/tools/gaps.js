/* Ό,τι ξέρουν τα αγγλικά, πρέπει να το ξέρουν και οι άλλες τέσσερις — αλλιώς ο
...
(async () => {
  ...
  /* Τα ισπανικά δεν έχουν κανονισμό στο αποθετήριο, οπότε δεν έχουν και στήλη
     στο γλωσσάρι. Η οθόνη τους είναι ολόκληρη επαγγελματική, μη επίσημη
     μετάφραση — και οι όροι μαζί — και το λέει η ίδια στη Γλώσσα. Άρα εδώ
     δεν τους λείπει τίποτε: ό,τι ξέρουν τα αγγλικά το ξέρουν κι αυτά. */
  const GLOSSARY_GAPS = {
    en: [], fr: [], es: [],
  ...
  console.log(bad ? '\n' + bad + ' κλειδιά χωρίς μετάφραση'
                  : '\nκάθε κλειδί που ξέρουν τα αγγλικά, το ξέρουν και οι τέσσερις άλλες');
